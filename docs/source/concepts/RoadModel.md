...
and arbitrary custom data. Full data model and the catalogue of available types: [Attributes](/concepts/Attributes.md).
To add and edit them in the editor, see [Attribute Mode](/editing/AttributeMode.md).

## See also

- [Attributes](/concepts/Attributes.md) — the attribute data model, keys, and the catalogue of types.
